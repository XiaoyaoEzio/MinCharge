...
public class CommandController {
    ...
    public @ResponseBody
    JsonResult connect(HttpServletRequest request,
    ...
    public @ResponseBody
    JsonResult pause(HttpServletRequest request,
                     @RequestParam(name = "token", required = true) String token,
    ...
    public @ResponseBody
    JsonResult stop(HttpServletRequest request,
                    @RequestParam(name = "token", required = true) String token,
                    @RequestParam(name = "deviceSn", required = true) String deviceId,
                    @RequestParam(name = "path", required = false) String path) {
    ...
    public @ResponseBody
    JsonResult regain(HttpServletRequest request,
                      @RequestParam(name = "token", required = true) String token,
                      @RequestParam(name = "deviceSn", required = true) String deviceId,
                      @RequestParam(name = "path", required = false) String path) {
    ...
    public @ResponseBody
    JsonResult state(HttpServletRequest request,
                     @RequestParam(name = "token", required = true) String token,
                     @RequestParam(name = "deviceSn", required = true) String deviceId,
                     @RequestParam(name = "path", required = false) String path) {
